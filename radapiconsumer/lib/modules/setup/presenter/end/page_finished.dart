...
class PageFinished extends StatefulWidget {
  @override
  _PageFinishedState createState() => _PageFinishedState();
}

final String strTitle = 'Etapa concluída';
final String strText =
    'Esta configuração está finalizada.\nPara usar o aplicativo integralmente confirme os seus e-mails.\nQualquer dúvda não exite em entrar em contato conosco.\nValeu!';

final Widget svg = SvgPicture.asset(
  "assets/svg/" "undraw_completing_6bhr.svg",
);

class _PageFinishedState extends State<PageFinished> {
  @override
